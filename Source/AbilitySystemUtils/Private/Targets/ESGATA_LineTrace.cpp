...
AESGATA_LineTrace::AESGATA_LineTrace()
{
}

void AESGATA_LineTrace::Configure(
...
void AESGATA_LineTrace::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World,
...
void AESGATA_LineTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType,
                                       float Duration)
{
...
void AESGATA_LineTrace::DrawDebugLineTraceMulti(const UWorld* World, const FVector& Start, const FVector& End, EDrawDebugTrace::Type DrawDebugType, bool bHit, const TArray<FHitResult>& OutHits, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime)
{
