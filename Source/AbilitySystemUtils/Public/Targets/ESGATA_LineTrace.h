...
#include "ESGATA_LineTrace.generated.h"

/**
* Reusable, configurable line trace TargetActor.
* Meant to be used with ESAT_WaitTargetDataUsingActor instead of the default WaitTargetData AbilityTask as the default
* one will destroy the TargetActor.
*/
UCLASS()
class ABILITYSYSTEMUTILS_API AESGATA_LineTrace : public AESGATA_Trace
{
	GENERATED_BODY()
