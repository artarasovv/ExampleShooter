...
#include "ESAT_WaitTargetDataUsingActor.generated.h"
...
*/
UCLASS()
class ABILITYSYSTEMUTILS_API UESAT_WaitTargetDataUsingActor : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	static UESAT_WaitTargetDataUsingActor* WaitTargetDataWithReusableActor(
		UGameplayAbility* OwningAbility,
		FName TaskInstanceName,
		TEnumAsByte<EGameplayTargetingConfirmation::Type> ConfirmationType,
		class AGameplayAbilityTargetActor* InTargetActor,
