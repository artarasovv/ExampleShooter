...
#include "ESAT_PlayMontageForMeshWaitEvent.generated.h"

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FESPlayMontageForMeshAndWaitForEventDelegate, FGameplayTag, EventTag,
...
*/
UCLASS()
class ABILITYSYSTEMUTILS_API UESAT_PlayMontageForMeshWaitEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	UESAT_PlayMontageForMeshWaitEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FESPlayMontageForMeshAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FESPlayMontageForMeshAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FESPlayMontageForMeshAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FESPlayMontageForMeshAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FESPlayMontageForMeshAndWaitForEventDelegate EventReceived;
	...
	static UESAT_PlayMontageForMeshWaitEvent* PlayMontageForMeshAndWaitForEvent(
...
private:
	...
	class UESAbilitySystemComponent* GetTargetASC();
