...
#include "ESGameplayEffectTypes.generated.h"
...
*/
USTRUCT()
struct ABILITYSYSTEMUTILS_API FESGameplayEffectContext : public FGameplayEffectContext
{
...
public:
	...
	*/
	...
	{
		return FESGameplayEffectContext::StaticStruct();
	}

	virtual FESGameplayEffectContext* Duplicate() const override
	{
		FESGameplayEffectContext* NewContext = new FESGameplayEffectContext();
		*NewContext = *this;
...
template <>
struct TStructOpsTypeTraits<FESGameplayEffectContext> : public TStructOpsTypeTraitsBase2<FESGameplayEffectContext>
{
	enum
	{
